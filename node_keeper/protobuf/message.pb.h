...
PROTOBUF_NAMESPACE_OPEN
template<> ::membership::MemberFullState* Arena::CreateMaybeMessage<::membership::MemberFullState>(Arena*);
template<> ::membership::MemberUpdate* Arena::CreateMaybeMessage<::membership::MemberUpdate>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace membership {
...
constexpr MemberUpdate_MemberStatus MemberUpdate_MemberStatus_MemberStatus_MIN = MemberUpdate_MemberStatus_UP;
constexpr MemberUpdate_MemberStatus MemberUpdate_MemberStatus_MemberStatus_MAX = MemberUpdate_MemberStatus_DOWN;
constexpr int MemberUpdate_MemberStatus_MemberStatus_ARRAYSIZE = MemberUpdate_MemberStatus_MemberStatus_MAX + 1;
                                                              ...
                                                              */
{
 public:
  ...
  friend void swap(MemberUpdate& a, MemberUpdate& b) {
    a.Swap(&b);
  }
  ...
  static constexpr MemberStatus UP =
    MemberUpdate_MemberStatus_UP;
  static constexpr MemberStatus DOWN =
...
class MemberFullState :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:membership.MemberFullState) */ {
 public:
  MemberFullState();
  virtual ~MemberFullState();

  MemberFullState(const MemberFullState& from);
  MemberFullState(MemberFullState&& from) noexcept
    : MemberFullState() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(MemberFullState& a, MemberFullState& b) {
    a.Swap(&b);
  }
...
inline void MemberUpdate::set_status(::membership::MemberUpdate_MemberStatus value) {
...
inline const ::membership::MemberUpdate& MemberFullState::states(int index) const {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::membership::MemberUpdate >&
